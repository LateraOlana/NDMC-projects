...
<hr>
<div id="ac">
<span>number: </span><br><span><input type="text" style="width:200px; height:30px;" name="no" placeholder="number" /></span>
<br><span>date: </span><span><br><input type="date" style="width:200px; height:30px;" name="date" required/><br>
  ...
  <br>
  <span>confirmed number: </span><br><span><input type="text" style="width:200px; height:30px;" name="confirmed_no" placeholder="confirmed number" /></span>
  <br>
  <span>country:
  <SELECT name="c_name" style="width:200px;">
  <?php
