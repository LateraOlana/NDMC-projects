...
<a rel="facebox" href="addcase.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" />Add case</button></a><br><br>
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<?php
				include('conn0.php');
				$result = $db->prepare("SELECT * FROM case_by_country,country where case_by_country.c_id=country.c_id ");
				$result->execute();
			...
			<td><a  title="Click To Edit data" rel="facebox" href="editcase_c.php?id=<?php echo $row['case_id']; ?>"><button class="btn btn-warning btn-mini"> Edit </button></a>
			<a href="#" id="<?php echo $row['case_id']; ?>" class="delbutton" title="Click To Delete"><button class="btn btn-danger btn-mini">Delete</button></a></td>
			</tr>
			<?php
				}
			?>
